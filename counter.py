...
SecondYearCount = Log.count("1995")
print("Number of accsesses from 1994:", FirstYearCount)
print("Number of accsesses from 1994 and 1995:", FirstYearCount + SecondYearCount)